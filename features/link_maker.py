...
def links(dest, loc_classes, switch):
    ...
    if loc_classes['loc_type'] == 'country' or loc_classes['loc_type'] == 'big_city':
    ...
    if (switch == "German" or loc_classes['language'] == 'german') \
        ...
        if country_de == "südafrika":
            links_dic['lp'] = "https://www.lonelyplanet.de/reiseziele/suedafrika/index-5718.html"
        else:
    ...
    if switch == "German" or loc_classes['language'] == 'german':
        # Country
        if loc_classes['loc_type'] == 'country':
            links_dic['maps'] = "https://www.google.com/maps/embed/v1/search?key=" \
    ...
    if loc_classes['language'] == "german" or switch == "German":
        ...
        if ReiseKlima.query \
            ...
            links_dic['reise_klima'] = "https://www.reise-klima.de/klima/" + des

        # Else go to optimale-reisezeit.de
        elif loc_classes['loc_type'] == "country" or loc_classes['loc_type'] == "big_city":
            links_dic['reisezeit'] = "https://www.optimale-reisezeit.de/" + co_de

        # Good luck mode
        else:
            links_dic['google_clima'] = "https://www.google.com/search?q=climate+" \
                                        + dest
    # English
    else:
        if loc_classes['loc_type'] == "country" or loc_classes['loc_type'] == "big_city":
    ...
    if switch == "German" or loc_classes['language'] == 'german':
        ...
        # Good luck mode
            ...
            links_dic['medi_de'] = "https://www.fit-for-travel.de/%c3%bcber-300-reiseziele/"

    # English
    else:
        # Country
        if loc_classes['loc_type'] == 'country':
            links_dic['medi_en'] = "https://wwwnc.cdc.gov/travel/destinations/traveler/none/" \
                                + co_en
        # Big City
        elif loc_classes['loc_type'] == 'big_city':
            links_dic['medi_en'] = "https://wwwnc.cdc.gov/travel/destinations/traveler/none/" \
        ...
        # Good luck mode
            ...
            links_dic['medi_en'] = "https://wwwnc.cdc.gov/travel/destinations/list/"
    ...
    # English
        ...
        # Country or big_city -> country knwown
        if loc_classes['loc_type'] == "country" or loc_classes['loc_type'] == "big_city":
            links_dic['power_en'] = "https://www.power-plugs-sockets.com/" + co_en
        # Good luck mode
        else:
    ...
    if loc_classes['language'] == "german" or switch == "German":
        ...
        if loc_classes['loc_type'] == "country" or loc_classes['loc_type'] == "big_city":
            # Exception
            if country_iso == "kr":
                links_dic['gov_de'] = "https://www.auswaertiges-amt.de/de/aussenpolitik/laender/korearepublik-node"
            else:
                links_dic['gov_de'] = "https://www.auswaertiges-amt.de/de/aussenpolitik/laender/" \
                                        + co_de + "-node"
        # Good luck mode
        else:
            links_dic['gov_de'] = "https://www.auswaertiges-amt.de/de/aussenpolitik/laender/"
    # English
        ...
        # Country or big_city -> country knwown
        if loc_classes['loc_type'] == "country" or loc_classes['loc_type'] == "big_city":
            links_dic['gov_en'] = "https://travel.state.gov/content/travel/en/traveladvisories/traveladvisories/" \
                                    +  co_en + "-travel-advisory.html"
        # Good luck mode
        else:
            links_dic['gov_en'] = "https://travel.state.gov/content/travel/en/international-travel/International-Travel-Country-Information-Pages.html"
    ...
    if switch == "German" or loc_classes['language'] == 'german':
        # Country
        if loc_classes['loc_type'] == 'country':
            links_dic['booking'] = "https://www.booking.com/searchresults.de.html?%&ss=" \
                                + co_de \
    ...
    # English
        ...
        # Country
        if loc_classes['loc_type'] == 'country':
            links_dic['booking'] = "https://www.booking.com/searchresults.en.html?%&ss=" \
                                + co_en \
                                + "&group_adults=2&group_children=0&no_rooms=1" \
                                + "&order=bayesian_review_score"
    ...
    # German
    if switch == "German" or loc_classes['language'] == 'german':
        links_dic['kayak'] = "https://www.kayak.de/explore/FRA-anywhere?stops=0"
        links_dic['lh'] = "https://www.lufthansa.com/de/de/homepage"

    # English
    else:
        links_dic['kayak'] = "https://www.kayak.com/explore/FRA-anywhere?stops=0"
