...
def weather_widget(loc_classes, switch):
    """Weather widget"""
    #url
    #Example: "https://api.openweathermap.org/data/2.5/forecast?q=germany&cnt=30&units=metric&lang=de&appid=0c18985590cdc49853beafcf5eb1edce"
    url_city = "https://api.openweathermap.org/data/2.5/forecast?q={},{}&cnt={}&units=metric&lang={}&appid=0c18985590cdc49853beafcf5eb1edce"
    url_country = "https://api.openweathermap.org/data/2.5/forecast?q={}&cnt={}&units=metric&lang={}&appid=0c18985590cdc49853beafcf5eb1edce"
    ...
    try:
        ...
        weather.append({"dest" : r["city"]["name"],
        ...
        for i in range(0, 2):
            ...
            for j in range(1, cnt):
                 ...
                 #Get forecast day and time, by converting unix time, as month day integer
                 day_utc = datetime.utcfromtimestamp(unix_time)
                 day = (day_utc + hour_delta).strftime('%d')
